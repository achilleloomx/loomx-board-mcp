...
43 tool base esposti a ogni agente (24 board/gtd/wi/runtime/ping + 9 doc_* document model + 6 subscription tool + 3 staleness/decay tool + 1 `org_lookup`) + 8 tool home_* (condizionali, richiedono HOME_FAMILY_ID + HOME_USER_ID):
